      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Tampa Bay&apos;s trusted junk removal service. Same day pickup,
              upfront pricing, eco-friendly disposal.
            </p>
            {/* Social links */}
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-blue-600/20 transition-colors"
                aria-label="Facebook"
              >
                <svg
                  className="w-5 h-5"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-pink-600/20 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-white/20 transition-colors"
                aria-label="TikTok"
              >
                <svg
                  className="w-5 h-5"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">Tampa Bay, FL</span>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-xs">
            &copy; {new Date().getFullYear()} JunkBot LLC. All rights reserved.
          </p>
          <p className="text-gray-500 text-xs">
